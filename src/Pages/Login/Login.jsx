...
export default function Login() {
  ...
  <div class="h-full">
    <div
      class="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between ml-16">
      <div
      ...
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-blue-700 dark:text-blue-700">
        ...
        <form>
          <div
            ...
            <p class="mb-0 mr-4 text-lg">Iniciar sesión con: </p>
            <button
              type="button"
              data-te-ripple-init
          ...
          <div class="text-center lg:text-left">
            <button
              type="button"
              class="bg-blue-700 inline-block rounded bg-primary px-7 pt-3 pb-2.5 text-sm font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]"
              data-te-ripple-init
              data-te-ripple-color="light">
              Iniciar
            </button>
