...
<button href="#" className="ml-96 hover:bg-blue-700 inline-flex items-center px-4 py-2 mr-3 text-sm font-medium border border-gray-300 rounded-lg ">
  <svg  
...
<button href="#" className="mr-96 hover:bg-blue-700 inline-flex items-center px-4 py-2 text-sm font-medium border border-gray-300 rounded-lg">
  Siguiente
  <svg 
